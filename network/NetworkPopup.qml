...
Item {
    ...
    Settings {
        id: cache
        location: "file://" + Quickshell.env("HOME") + "/.cache/qs-network-popup.ini"
                                ...
                                NumberAnimation {
                                    ...
                                    onFinished: {
                                        ...
                                        let cmd = window.activeMode === "wifi"
                                            ? "true"  // Ethernet cannot be disconnected
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: 8
                            Text { font.family: "Iosevka Nerd Font"; font.pixelSize: 18; color: window.activeMode === "wifi" ? window.crust : window.text; text: "󰈀"; Behavior on color { ColorAnimation{duration:200} } }
                            Text { font.family: "JetBrains Mono"; font.weight: Font.Black; font.pixelSize: 13; color: window.activeMode === "wifi" ? window.crust : window.text; text: "Ethernet"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        if (window.activeMode === "wifi") {
                            ...
                            // Ethernet cannot be toggled — no-op
                            window.wifiPowerPending = false;
                        } else {
